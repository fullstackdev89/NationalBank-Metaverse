          ...
          <div className="sm:mt-20">
            <div className="sm:flex justify-between gap-10 items-center">
              <div className="sm:w-1/2">
                <p className="text-white text-center sm:text-start text-3xl sm:text-6xl font-bold">
                  First National Bank
                ...
                <div className="bg-white text-black mt-6 sm:mt-10 flex justify-between items-center px-2">
                  <input
                    type={"text"}
                    className="bg-transparent outline-0 h-14 sm:h-16 px-4 w-full"
                    placeholder="Enter your wallet address"
                  />
                  <button className="bg-black text-white text-md sm:text-lg font-medium h-10 sm:h-12 w-[200px]">
                    Connect Wallet
                  </button>
                </div>
              </div>
